...
class ProfileInfoHeaderCollectionReusableView: UICollectionReusableView {
    ...
    private let bioLabel: UILabel = {
        let label = UILabel()
        label.text = "This is First count!"
        label.textColor = .label
    ...
    private func addSubviews() {
        [profilePhotoImageView, followingButton, followersButton, postsButton, bioLabel, nameLabel, editProfileButton].forEach {
            addSubview($0)
        }
    }
    ...
    // MARK: - Action
    @objc
    private func didTapFollowerButton() {
