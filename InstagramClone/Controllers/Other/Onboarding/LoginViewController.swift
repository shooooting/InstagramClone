...
class LoginViewController: UIViewController {
    ...
    private let termsButton: UIButton = {
       let button = UIButton()
        button.setTitle("Terms of Servied", for: .normal)
    ...
    private func addSubViews() {
        [usernameEmailField, passwordField, loginButton, termsButton, privacyButton, createAccountButton, headerView].forEach {
            view.addSubview($0)
        }
    }
    ...
    private func didTapCreateAccountButton() {
        let vc = ResgistrationViewController()
        present(vc, animated: true)
    }
}
